...
function RenderAbout({ about }) {
    ...
    return (
        <>
            ...
            <div className="row">
                <div className="col-8 mx-auto pb-5 text-center"><a className="btn mainButton downloadButton" href={"/assets/images/aliciaMorleyResumeV1.pdf"} alt='resume' title="download my resume">{download}</a>
                </div>
            </div>
            <div className="row">
