...
export const ABOUT = [

    {
        ...
        titleDesign: 'DESIGN',
        design: ['FIGMA', 'SKETCH', 'ADOBE PHOTOSHOP', 'ADOBE ILLUSTRATOR', 'MAILCHIMP', 'SHOPIFY', 'AMAZON STORE FRONTS'],
...
export const PORTFOLIOWORK = [
    {
        ...
        img2: '/assets/images/90DegreeLayoutExample.jpg',
        img3: '/assets/images/90DegreeEmail.jpg',
        overlay: 'darkGrey',
        font: 'white',
    },
    {
