...
export const ABOUT = [

    {
        ...
        experienceList: ['FULLSTACK BOOTCAMP 2020 ~- NUCAMP CALIFORNIA, USA', 'BA HONS TEXTILE DESIGN ~- CHELSEA COLLEGE OF ART, LONDON UK', '15 YEARS GRAPHIC DESIGN ~- VARIOUS COMPANIES GLOBALLY'],
...
export const PORTFOLIOWORK = [
    {
        ...
        objective: 'For my role at 90 Degree by reflex website I create bi-weekly Shopify and Mailchimp graphics. I use photoshop for the graphics and photo editing and update the platform adding assets and text for products and descriptions.',
        ...
        website: "For the bi-weekly design layouts for the banners I create a theme for each promotion. I use a consistant text in various weights of Poppins for the button and secondary information and then choose a dynamic header font to distinguish the separate campaigns. For the colour selection I use complimentary colours to the Lifestyle photography and consider WCAG standards for accessibility when placing text over backgrounds. For the overall placement I consider the UI, how the graphics flow and the promoitional information leads to the ‘shop now’ button for a user friendly experience. I also photo edit the images depending on the layout of the graphic by extending background scenery, adding a new relevant garment to a model in a lifestyle shot or colour change a garment in-line with stock availability.",
        siteAdressWeb: 'https://www.90degreebyreflex.com/',
        siteAdressGit: 'None',
        ...
        html: 'The bi-weekly email campaign mirror the online promotion. I scale and export the graphics for web optimization to improve loading speed. I choose the products displayed under the main banner images depending on the current price promotion whilst also checking stock availability on Shopify.',
    ...
    },
    {
        ...
        objectiveTitle: 'ROLE DESCRIPTION',
        objective: 'I create Yogalicious bi-weekly Shopify and Mailchimp graphics and banners using photoshop. I update the platform adding assets and text for products and descriptions. I also schedule the email send outs and publish the website.',
        contributorsTitle: 'CONTRIBUTORS',
        ...
        programs: 'Adobe Photoshop, Shopify, Mailchimp, HTML',
        websiteTitle: 'WEBSITE',
        website: 'For the bi-weekly design layouts for the banners I create a theme for each promotion. I use a consistant text in various weights of Poppins for the button and secondary information and then choose a dynamic header font to distinguish the separate campaigns. For the colour selection I use complimentary colours to the Lifestyle photography and consider WCAG standards for accessibility when placing text over backgrounds. For the overall placement I consider the UI, how the graphics flow and the promoitional information leads to the ‘shop now’ button for a user friendly experience. I also photo edit the images depending on the layout of the graphic by extending background scenery, adding a new revelvant garment to a model in a lifestyle shot or colour change a garment in-line with stock availability.',
    ...
    },
    {
        ...
        titleExample: 'PORTFOLIO WEBSITE',
        objectiveTitle: 'OBJECTIVE',
        objective: 'To design then develop a game ratings promo site with sort, select and flip card functionality. Technologies used include Figma, Photoshop, Afer Effects, React, MongoDB Atlas, Express, Node JS.',
        contributorsTitle: 'CONTRIBUTORS',
        contributors: ['Website Development: Alicia Morley', 'Website Design: Alicia Morley', 'HTML Email Design: Alicia Morley', 'HTML Email Development: Alicia Morley', 'Images: Unsplashed, Pexels'],
        programsTitle: 'DESIGN & DEVELOPEMENT',
        ...
        emailHtmlAdress: 'https://github.com',
        emailHtmlGit: 'https://github.com',
