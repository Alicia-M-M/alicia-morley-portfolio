...
export const PORTFOLIOWORK = [
    ...
    },
    {
        ...
        description: 'WORDPRESS AFTER EFFECTS FIGMA PHOTOSHOP',
        img1: '/assets/images/interiorsFrontV1.jpg',
        titleExample: 'PORTFOLIO WEBSITE',
        objectiveTitle: 'OBJECTIVE',
        objective: 'To design then develop an interior design and lifestyle retail website with a blog. Technologies used include Figma, Photoshop, After Effects and Wordpress CMS.',
        contributorsTitle: 'CONTRIBUTORS',
        contributors: ['Website Development: Alicia Morley', 'Website Design: Alicia Morley', 'HTML Email Design: Alicia Morley', 'HTML Email Development: Alicia Morley', 'Images: Unsplashed, Pexels'],
        programsTitle: 'DESIGN & DEVELOPEMENT',
        programs: 'Figma, Photoshop, After Effects,Wordpress CMS',
        websiteTitle: 'WEBSITE',
        website: "COMING SOON WIP! My main goal for this site is to create a modern, fresh and contemporary interior retail site with a blog that can be updated with industry knowledge, events and information. My concept is prototyped in Figma and the site itself will be a customized Wordpress site. I'm choosing to adapt an exsisting theme rather than build from scratch. This will be a great example of adjusting an already existing sites functionality and layout. Aswell as the site I'll be creating social media marketing assets to compliment a ficitional online sale.",
