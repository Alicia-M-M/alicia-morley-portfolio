...
export const PORTFOLIOWORK = [
    {
        ...
        website: "Working at Kate Spade I design assets for various Mainsite and Surprise projects including desktop and mobile web banners, social media posts and MP4 animations. I work in a fast past environment where accuracy and consistency are really important when designing multple versions of assets across several online platforms. Excellent communication skills and time management are needed as I work directly with several teams across the organisation including marketing, sales and copywriters. Precise file organization, file naming and self management are key to ensure an efficient working environment within our design team. When designing assets I use mainly Figma, Photoshop and After Effects, including the utilisation and customisation of the Kate Spade Figma Component Design Library.",
        siteAdressWeb: 'https://www.figma.com/proto/ZU8fSjFEEwedK8je07J0I7/KateSpade_Work?page-id=0%3A1&node-id=524-45&starting-point-node-id=524%3A45&scaling=scale-down-width&mode=design&t=hGRHtA4FV5tCuzEC-1',
        ...
        siteFigma: 'https://www.figma.com/proto/ZU8fSjFEEwedK8je07J0I7/KateSpade_Work?page-id=0%3A1&node-id=524-45&starting-point-node-id=524%3A45&scaling=scale-down-width&mode=design&t=hGRHtA4FV5tCuzEC-1',
